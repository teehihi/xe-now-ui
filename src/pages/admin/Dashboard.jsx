...
import { revenueData, vehicleTypeRevenue, bookings, vehicles } from '../../data/mockData';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
          ...
          <div className="space-y-3">
            {bookings.map((b) => (
              <div key={b.id} className="flex items-center justify-between p-3 bg-[#F8FAFC] rounded-xl border border-gray-100">
                <div>
                  <p className="text-sm font-medium text-gray-900">{b.vehicleName}</p>
                  <p className="text-xs text-gray-500">{b.customerName}</p>
                </div>
                <div className="text-right flex items-center gap-3">
                  <span className="text-sm text-gray-600">{(b.total/1000000).toFixed(1)} Tr ₫</span>
