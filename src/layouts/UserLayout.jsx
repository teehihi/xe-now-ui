        ...
        <div className="max-w-7xl mx-auto px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div className="lg:col-span-1">
              <img src="/images/logo.webp" alt="XeNow" className="h-14 mb-3" onError={(e) => {
                e.target.style.display = 'none';
              }} />
              <p className="text-sm leading-relaxed mb-3 text-gray-400">Nền tảng cho thuê xe hàng đầu Việt Nam. Đặt xe dễ dàng, lái xe an toàn.</p>
              <div className="flex items-start gap-2 text-xs mb-4 text-gray-500">
                <svg width="14" height="14" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" className="flex-shrink-0 mt-0.5">
                  <path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c3 3 9 3 12 0v-5"/>
                </svg>
                <span>Đồ án môn học – HCMUTE</span>
              </div>
              <div className="flex gap-2">
                {[
                  ...
                  <a key={i} href="#" className="w-8 h-8 rounded-lg bg-[#1E293B] hover:bg-[#334155] flex items-center justify-center transition-colors" aria-label={social.label}>
                    <svg width="14" height="14" fill="currentColor" viewBox="0 0 24 24"><path d={social.icon}/></svg>
                  </a>
                ))}
              </div>
            </div>
            ...
            {/* Dịch vụ */}
            <div>
              <h4 className="text-white font-semibold mb-4 text-sm">Dịch vụ</h4>
            ...
            <div>
              ...
              <div className="space-y-2.5 text-sm">
                <div className="flex gap-2">
                  ...
                  <span>01 Võ Văn Ngân, Linh Chiểu, Thủ Đức, TP.HCM</span>
                </div>
            ...
            {/* Google Map */}
            <div>
              <h4 className="text-white font-semibold mb-4 text-sm">Vị trí</h4>
              <iframe
          ...
          {/* Bottom bar */}
          <div className="pt-6 border-t border-gray-800 flex flex-col md:flex-row items-center justify-between gap-4 text-xs">
